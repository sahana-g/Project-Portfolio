...
def file_to_mrna(input_file):
    ...
    with open(input_file) as f:
        for line in f:
            ...
            ret_seq = subprocess.Popen(["./twoBitToFa", "hg38.2bit", "placeholder_file_n.fa", ar4, ar5, ar6])
            for seq_record in SeqIO.parse("placeholder_file_n.fa", "fasta"):
...
mrna_seqs = file_to_mrna("renamed_neg_overlaps.bed")
print(mrna_seqs)
...
# In[ ]:
file_to_write = open('neg_overlap_frag_mrna_seqs.pickle', "wb")
